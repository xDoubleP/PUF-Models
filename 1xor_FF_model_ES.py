...
puf = pypuf.simulation.XORFeedForwardArbiterPUF(n=64, k=2, ff=[(10, 20)], seed=1)
challenges = pypuf.io.random_inputs(n=64, N=2000, seed=123)
responses = puf.eval(challenges)

data_inputs = parity_vector.get_parity_vectors(challenges)
# X = challenges
data_outputs = (1 - responses) // 2  # convert -1s to 0s
# y = responses
...
num_parents_mating = 75 # Number of solutions to be selected as parents in the mating pool.
