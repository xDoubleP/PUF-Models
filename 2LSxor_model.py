...
puf = pypuf.simulation.LightweightSecurePUF(n=64, k=2, seed=1)
challenges = pypuf.io.random_inputs(n=64, N=100000, seed=123)
...
results = model.fit(X_train, y_train, epochs=300, batch_size=1000,
