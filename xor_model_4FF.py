...
puf = pypuf.simulation.XORFeedForwardArbiterPUF(
    n=64, k=2, ff=[(10, 20), (20, 30), (30, 40), (40, 50)], seed=1)
challenges = pypuf.io.random_inputs(n=64, N=600000, seed=123)
...
results = model.fit(X_train, y_train, epochs=1500, batch_size=1000,
