...
puf = pypuf.simulation.LightweightSecurePUF(n=64, k=3, seed=1)
challenges = pypuf.io.random_inputs(n=64, N=300000, seed=123)
...
model.add(Dense(65, input_dim=X.shape[1], activation='relu'))
...
results = model.fit(X_train, y_train, epochs=150, batch_size=1000,
